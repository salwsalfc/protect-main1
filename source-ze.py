...
p5 = types.InlineKeyboardButton(text = "🔱 ادارة التقياء المسائية🔱",url="t.me/aliccod")
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    ...
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/aliccod")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/co_od")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا وسهلا بكم في كࢪوب الثاني متوسط الاتقياء 
[قناة السورس .](t.me/aliccod)
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 ادارة التقياء المسائية🔱",url="t.me/aliccod")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @aliccod*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 ادارة التقياء المسائية🔱",url="t.me/aliccod")
	p3.add(p5)
...
- @Sss0s0bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
		bot.reply_to(message,"اطرح سؤالك بدون مقدمات ")
	elif message.text == "اشقة ":
		bot.reply_to(message,"احترم نفسك احسلك بدون تجاوز ")
	elif message.text=="باجر عطلة":
		bot.reply_to(message,"اذا جنت غير متاكد لتحجي بكيفك ")
	elif message.text=="صباح الخير":
			bot.reply_to(message,".صباඋ النوࢪ ")
	elif message.text=="ولي":
			bot.reply_to(message,".احترم نفسك لاشك حلكك")
	elif message.text=="شلونك استاد":
			bot.reply_to(message,"تمام وانت 🌹")
	elif message.text=="دي":
			bot.reply_to(message,"قليل ادب احترم نفسك ")
	...
	elif message.text=="زربه ":
		bot.reply_to(message,"احترم نفسك لاشك خلككك ابني")
	elif message.text=="كلخرا":
		bot.reply_to(message,"ولك احترم لاشك حلككك ")
	elif message.text=="🥺":
		bot.reply_to(message,"لاتحزن ان الله معنا ")
	elif message.text ==".":
	  bot.reply_to(message,"الهم صلي على محمد وآل محمد ")
	elif message.text =="باجر عطلة ":
